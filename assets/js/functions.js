...
y.prototype.j = function(a) {
  ...
  b && "m" == b[0] && b[1] == this.i && a.origin == this.k && (a = "display: inline;max-width: 100%;min-width: 220px;padding: 0;position: static;visibility: visible;", "false" !== this.g.getAttribute("data-border") && (a += "border-top-left-radius: 5px;border-top-right-radius: 5px;border-bottom-right-radius: 5px;border-bottom-left-radius: 5px;border-color: #eee #ddd #bbb;border-width: 1px;border-style: solid;box-shadow: rgba(0, 0, 0, 0.15) 0px 1px 3px;"), this.h.setAttribute("style", a), this.h.setAttribute("height",
  b[2]));
};
function A() {
  this.n = 0;
